...
def main():
    ...
    # Create config for future measurements
    config_code = f'''# Calibrated configuration
# Generated by calibrate_scale.py
...
def get_config():
    ...
    config.scale_recovery = ScaleRecoveryConfig(
        ...
        default_scale={scale_factor:.6f}  # Calibrated scale factor
    )
    return config
...
'''
    ...
    config_file = Path("configs/calibrated_config.py")
    config_file.parent.mkdir(exist_ok=True)
    with open(config_file, 'w') as f:
        f.write(config_code)
    
    print(f"[CREATED] Configuration saved to: {config_file}")
    print()
    print("To use this calibration for future measurements:")
    print(f"  python main.py measure --config {config_file} resized\\*.jpg")
    print()
    print("=" * 60)
